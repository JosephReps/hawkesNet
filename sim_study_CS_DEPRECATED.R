...
params_true <- list(
  ...
  node_lambda = as_num(Sys.getenv("TRUE_NODE_LAMBDA", ""), 4),
  CS_params = CS_true
)
...
params_true_2 <- params_true
params_true_2 <- params_true_2[1:5]
params_true_2$CS_edges <- -2.0
params_true_2$CS_triangles <- 0.001
params_true_2$CS_star.2 <- 0
params_true_2$CS_star.3 <- 0
TRANSFORM$CS_edges <- "none"
TRANSFORM$CS_triangles <- "none"
TRANSFORM$CS_star.2 <- "none"
TRANSFORM$CS_star.3 <- "none"
